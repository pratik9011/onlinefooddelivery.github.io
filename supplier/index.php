...
$count = mysqli_num_rows($sqli_q);
    ...
    $sql = "select * from users1 where supp_username = '$username'";
...
if(isset($_POST['addproduct'])){
    if(isset($_FILES['img'])){
        ...
        $sql="INSERT into users1 values(DEFAULT,DEFAULT,'".$pname."', '".$pprice."', '".$pdescription."', '".$no.$file_name."', '".$ptype."',DEFAULT,'".$time."','".$username."')";
