...
$sql = "SELECT * FROM buy WHERE payid=$id";
...
$sql = "SELECT * FROM users1 WHERE pname='$pname'";
 $result = mysqli_query($conn, $sql);
while($row = mysqli_fetch_assoc($result)){
   $bid =$row['making_time'];
        ...
        <div class="modal-content" style=" background-color: whitesmoke;">
            ...
            <div class="modal-body">
                ...
                <div class="text-center text-success">
                 <?php   echo'<h4>Your ordered food Dilivard in <h4 class="text-warning">'.$bid.'M</h4>';
                 ?>
                    </h4>

                </div>
                <?php   echo'<div class="">
             <a href="print.php?Gpayid='.$id.'" class="btn btn-primary form-control my-2">Print</a>
             </div>';
             ?>
