<?php 
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // $existe=false;
     ...
     $existesql = "SELECT * FROM users WHERE username = '$username'";
     ...
     if(($password == $cpassword)){
       $hash = password_hash($password, PASSWORD_DEFAULT);
         $sql = "INSERT INTO users  VALUES (DEFAULT,'$username','$hash', current_timestamp(),'$uname','$uemail','$uaddres','$ugender','$uphone','$ubrithdate','')";
